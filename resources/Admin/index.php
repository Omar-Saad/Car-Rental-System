...
<h1>
    ...
    <a href="" class="typewrite" data-period="2000"
       data-type='[ "Welcome , <?php echo $admin->getAdminName(); ?>.", "Car Rent."]'>
        ...
        <div class="row">
            ...
            <div
                    ...
                    style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;"><i
                        class="fas fa-calendar-check medium-icon"></i> <span id="anim-number-pizza"
                                                                             class="counter-number"></span> <span
                        class="timer counter alt-font appear" data-to="<?php echo $reservationCount; ?>"
                        data-speed="7000"><?php echo $reservationCount; ?></span>
            ...
            <div
                ...
                <i class="fas fa-users medium-icon"></i> <span class="timer counter alt-font appear"
                                                               data-to="<?php echo $customerCount; ?>"
                                                               data-speed="7000"><?php echo $customerCount; ?></span>
            ...
            <div
                ...
                <i class="fas fa-car medium-icon"></i> <span class="timer counter alt-font appear"
                                                             data-to="<?php echo $CarsCount; ?>"
                                                             data-speed="7000"><?php echo $CarsCount; ?></span>
            ...
            <div class="col-md-3 col-sm-6 text-center counter-section wow fadeInUp animated" data-wow-duration="1200ms"
                 style="visibility: visible; animation-duration: 1200ms; animation-name: fadeInUp;"><i
                        class="fas fa-money-check-alt medium-icon"></i> <span class="timer counter alt-font appear"
                                                                              data-to="<?php echo $revenue; ?>"
                                                                              data-speed="7000"><?php echo $revenue; ?></span>
                <span class="counter-title">Revenue</span></div> <!-- end counter -->
        </div>
    </div>
</section>
